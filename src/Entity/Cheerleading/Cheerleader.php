...
/**
 * @ORM\Table(name="cheerleader_table", options={"collate"="utf8_swedish_ci"})
 * @ORM\Entity
 ...
 */
class Cheerleader implements Serializable, CreatedByUserInterface, LoggableEntity
{
     ...
     * @Assert\NotBlank()
     * @var integer $classOf The class of the cheerleader
     */
    protected $classOf;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Schools\SchoolUnit", inversedBy="cheerleaders")
     * @ORM\JoinColumn(name="school_unit_fld", referencedColumnName="id_fld", nullable=false)
     * @Assert\NotBlank()
     * @var SchoolUnit $schoolUnit The SchoolUnit the cheerleader belongs to
     */
    protected $schoolUnit;

    /**
     * @ORM\OneToMany(targetEntity="MemberOfCheerleadingSquad", mappedBy="cheerleader", cascade={"persist", "remove"})
     * @var ArrayCollection $squads The cheerleading squads the cheerleader belongs to
     */
    protected $squads;
