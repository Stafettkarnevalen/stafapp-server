...
class Invoice implements \Serializable, CreatedByUserInterface, LoggableEntity
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Invoice", mappedBy="parent", cascade={"persist", "merge", "remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="InvoiceLine", mappedBy="invoice", cascade={"persist", "merge", "remove"})
